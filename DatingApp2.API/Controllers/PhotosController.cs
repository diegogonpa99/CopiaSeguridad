    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IDatingRepository repo, IMapper mapper, IOptions<CloudinarySettings> cloudinaryConfig)
        {
            ...
            Account acc = new Account(
                ...
                _cloudinaryConfig.Value.ApiSecret No me coge estos campos, asi que los hardcodeo*/
                "dqrugbxoi",
                "558863836731319",
                "EFTcf9zBsijN8kNVzPwCgrAH_P4"
            );
        ...
        public async Task<IActionResult> AddPhotoForUser(int userId, [FromForm] PhotoForCreation photoForCreation)
        {
            ...
            return BadRequest("No se ha podido añadir la foto");
        }
        ...
        public async Task<IActionResult> setMainPhoto(int userId, int id)
        {
            ...
            {
                return BadRequest("Esta ya es la foto de perfil");
            }
            ...
            return BadRequest("No se ha podido cambiar la foto de perfil");
        }
